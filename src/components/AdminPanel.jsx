...
//                     <Button className='btn-yellow' onClick={updateProduct}>Edit</Button>
//                     <Button className='btn-red' onClick={deleteProduct}>Remove</Button>
//                   </td>
//                 </tr>
//               ))}
//             </tbody>
